...
\section{Modeling}
    ...
    \subsection{Modeling it for Operator Splitting}
        ...
        \end{itemize}
        The above 3 functions represent the three parts of the summed objective. 
    ...
    \subsection*{A Quick Tour into Operator Splitting Method}
        ...
        We describe the algorithm in this section to provide context in the up comming part that discuss the implementations details. 
\subsection{Implementation, Software, and Toolings}
    ...
    \subsection{Projection onto Probability Simplex and Sparse Linear System}
        ...
        \begin{theorem}[Projecting onto Hyperplane Box Intersections]
