...
\section{Introduction}
    ...
    \subsection{Existence of a Minimizer}
        The function is a coersive function due to the non-smooth part. The function is also l.s.c. Therefore by the key minimizer existence theorem it has a minimizer. 
