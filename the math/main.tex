...
\section{Modeling}  
    ...
    \subsection*{Modeling it for Chambolle Pock}
        ...
        \begin{enumerate}
            \item [1.] Let $\phi(z)$ be a function mapping from $\mathbb R^{n^2}\oplus \mathbb R^{\mathbf C_2^{n^2}}$ such that the vector $z$ admits representation $[x \; y]^T$ where $x \in \mathbb R^{n^2}$ and $y \in \mathbb R^{\mathbf C_2^{n^2}}$. 
