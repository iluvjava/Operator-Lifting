...
\section{Introduction}
    ...
    \subsection{Existence of a Minimizer}
        ...
        \textcolor{red}{Are there gonna be minimizers in this case?}
...
\section{Modeling}  
    ...
    \subsection*{Modeling it for Chambolle Pock}
        ...
        \begin{enumerate}
            \item [1.] Let $\phi(z)$ be a function mapping from $\mathbb R^{n^2}\oplus \mathbb R^{\mathbf C_2^{n^2}}$ such that the vector $z$ admits representation $[x \; y]^T$ where $x \in \mathbb R^{n^2}$ and $y \in \mathbb R^{\mathbf C_2^{n^2}}$. Thsi function handles the smooth and nonsmooth objective given as 
            $$
                \phi(z) = f(x) + \Vert y\Vert_1. 
            $$
            \item [2.] Define 
            $$
                L= 
                ...
                \end{bmatrix}
            $$
            \item [3.] Let $\Phi(z) = \delta\{\Delta_{n\times n}\}(x) + \delta\{\mathbf 0\}(y)$. $\Phi$
        \end{enumerate}
